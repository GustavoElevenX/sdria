    ...
    <div className="grid min-h-[680px] grid-cols-[300px_1fr_320px] overflow-hidden rounded-lg border border-border bg-white">
      ...
      <main className="flex flex-col">
        ...
        <div className="border-t border-border p-4">
          <textarea className="h-20 w-full resize-none rounded-md border border-border p-3 text-sm outline-none focus:border-primary" placeholder="Mensagem humana ou nota interna" />
          <div className="mt-3 flex justify-end gap-2">
            <Button variant="secondary">Nota interna</Button>
            <Button>Enviar e pausar IA</Button>
          </div>
        </div>
      </main>
      <aside className="border-l border-border p-4">
        ...
        <div className="mt-4 grid gap-2">
          ...
          <Button variant="secondary">Devolver para IA</Button>
          <Button variant="secondary">Agendar reunião</Button>
          <Button variant="danger">Marcar opt-out</Button>
        </div>
      </aside>
    </div>
  );
